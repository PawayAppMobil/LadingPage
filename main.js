...
ScrollReveal().reveal(".body__image img", {
  ...scrollRevealOption,
  origin: "right",
});


ScrollReveal().reveal(".body__image2 img", {
  ...scrollRevealOption,
  origin: "right",
});
...
ScrollReveal().reveal(".header__content .section__description__none", {
  ...scrollRevealOption,
  delay: 1000,
});
...
ScrollReveal().reveal(".contact__content .section__header", {
  ...scrollRevealOption,
  delay: 500,
});
ScrollReveal().reveal(".contact__content .section__description", {
  ...scrollRevealOption,
  delay: 1000,
});
